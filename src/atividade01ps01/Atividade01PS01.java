...
public class Atividade01PS01 {
    ...
    public static void main(String[] args) {
        ...
        //linhas da matriz A e colunas da matriz A
        ...
        for (int l = 0; l < linhasA; l++) {
            for (int c = 0; c < colunasA; c++) {
                System.out.print("Elemento A(" + (l + 1) + "," + (c + 1) + "): ");
        ...
        int colunasB = scanner.nextInt();
                //linhas da matriz B e colunas da matriz B
        ...
        for (int l = 0; l < linhasB; l++) {
            for (int c = 0; c < colunasB; c++) {
                System.out.print("Elemento B(" + (l + 1) + "," + (c + 1) + "): ");
        ...
        if (colunasA != linhasB) {
            ...
            //Requisito 03
            //linhas da matriz A x colunas da matriz Bk 
            int [][] matrizC = new int[linhasA][colunasB];
            for (int l = 0; l < linhasA; l++) {
                for (int c = 0; c < colunasB; c++) {
                    for (int x = 0; x < colunasA; x++) {
                        matrizC[l][c] += matrizA[l][x] * matrizB[x][c];
                    }
                }
            }
